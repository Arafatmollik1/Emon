...
@Component({
  selector: 'app-windgust',
  templateUrl: './windgust.component.html',
  styleUrls: ['./windgust.component.css']
})
export class WindgustComponent implements OnInit, AfterViewInit{
  ...
  async genMapShapeFile(data_result:any) {
      ...
      this.mapLayer = L.geoJSON(data,{
        onEachFeature: function(feat,lyr){
          ...
          lyr.on({click: function(e) {
            ...
            that.fetchUpazilaData(u_code, 9);
          }})
    ...
    this.fetchUpazilaData(202224, 9);
  }
